...
{
    /// <summary>
    /// A static class to handle XAnim Procedural Bones Assets
    /// </summary>
    internal unsafe static class XAnimProceduralBonesHandler
    {
        /// <summary>
        /// Asset Structure
        /// </summary>
        public struct AssetStruct
        {
            ...
            public unsafe fixed byte Buffer[24];
        ...
        public static void LoadAsset(Zone zone, bool atStreamStart)
        {
            ...
            Global.DebugPrint($"Loading XAnim Procedural Bones: {new string(VarAsset->Name)}");
        }
    }
}
