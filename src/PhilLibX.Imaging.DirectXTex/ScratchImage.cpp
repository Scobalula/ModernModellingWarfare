...
using namespace PhilLibX::Imaging::DirectXTex;
...
PhilLibX::Imaging::DirectXTex::ScratchImage::ScratchImage(ScratchImageMetadata^ metaData, array<Byte>^ buffer)
{
...
PhilLibX::Imaging::DirectXTex::ScratchImage::ScratchImage(String^ filePath, ScratchImageFileFormat format)
{
...
void PhilLibX::Imaging::DirectXTex::ScratchImage::Load(array<Byte>^ buffer, ScratchImageFileFormat format)
{
	HRESULT result;
...
void PhilLibX::Imaging::DirectXTex::ScratchImage::Save(System::IO::Stream^ stream, ScratchImageFileFormat format)
{
	if (!ScratchImagePointer)
		throw gcnew ScratchImageException(String::Format("Failed to aquire DirectX::ScratchImage, result returned nullptr"));
...
void PhilLibX::Imaging::DirectXTex::ScratchImage::GenerateMipMaps(int mipMapCount)
{
	if (!ScratchImagePointer)
		throw gcnew ScratchImageException(String::Format("Failed to aquire DirectX::ScratchImage, result returned nullptr"));
...
IntPtr PhilLibX::Imaging::DirectXTex::ScratchImage::GetPixelsPointer(Int64% size)
{
	return GetPixelsPointer(0, 0, 0, size);
}

IntPtr PhilLibX::Imaging::DirectXTex::ScratchImage::GetPixelsPointer(int mip, int item, int slice, Int64% size)
{
...
Vector4 PhilLibX::Imaging::DirectXTex::ScratchImage::GetPixelValue(int mip, int item, int slice, int x, int y)
{
...
void PhilLibX::Imaging::DirectXTex::ScratchImage::GetPixelValue(int mip, int item, int slice, int x, int y, Vector4% value)
{
	if (x > Width)
...
void PhilLibX::Imaging::DirectXTex::ScratchImage::SetPixelValue(int mip, int item, int slice, int x, int y, Vector4 value)
{
	if (x > Width)
		throw gcnew ArgumentOutOfRangeException("x", "X must be less than the Width of the Image");
	if (y > Height)
